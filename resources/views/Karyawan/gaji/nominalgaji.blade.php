                      ...
                      <div class="col-lg-12">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <p>{{ $kehadirans }}</p>
                                  <?php
                                  $jumlah = count($kehadirans);
                                  echo $jumlah;
                                  ?>
                                  <p>{{ $nominal }}</p> -->
                                  <div class="form-validation">
                                      <!-- form -->
                                      <form class="form-valide" action="/nominal" method="post">
                                      @csrf
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-8">
                                                  <input type="text" class="form-control" id="gaji" name="gaji" required placeholder="Enter a gaji.. (RP.)">
                                                </div>
                                            </div>
                                          <div class="form-group row">
