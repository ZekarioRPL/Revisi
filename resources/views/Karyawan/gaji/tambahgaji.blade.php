                              ...
                              <div class="card-body">
                                  <div class="form-validation">
                                    ...
                                    ?>
                                      <!-- form -->
                                      @if($kondisi === '')
                                      <form action="/gaji/create" >

                                            <div class="form-group row">
                                              <label class="col-lg-4 col-form-label" for="karyawan_id">Nama Karyawan <span class="text-danger">*</span></label>
                                              <div class="col-lg-8">
                                                  <select class="js-nama_Karyawan form-control" id="nama" name="karyawan_id" style="width: 100%;" data-placeholder="Choose one.." required>
                                                      <option></option>
                                                      @foreach( $karyawans as $karyawan)
                                                        <option value="{{ $karyawan->id }}">{{ $karyawan->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <!-- <button type="button" class="btn btn-primary mt-2" onclick="cetak()">Tampilkan Gaji</button> -->
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                ...
                                @csrf
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-8">
                                                  <input type="number" class="gaji form-control" id="gaji" name="gaji" required value="{{ $jumlah }}" placeholder="Enter a gaji.. (RP.)">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-8">
                                                    <input type="hidden" class="form-control" id="karyawan" name="karyawan_id" value="{{ request('karyawan_id') }}" required>
                                                </div>
                                            </div>
                                            <!-- <div class="form-group row">
...
<!-- <script>
    function cetak() {
        ...
        document.getElementById('gaji').innerHTML = nama;
        const gaji_value = document.querySelector('.gaji');
        gaji_value.setAttribute('value', nama);
    }
</script> -->
    <!-- jquery vendor -->
